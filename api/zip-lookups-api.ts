...
export const ZipLookupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        zipLookup: async (zipEditable: ZipEditable, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ZipLookupsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async zipLookup(zipEditable: ZipEditable, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Zip>> {
...
export class ZipLookupsApi extends BaseAPI {
    ...
    public lookup(zipEditable: ZipEditable, options?: AxiosRequestConfig) {
        return ZipLookupsApiFp(this.configuration).zipLookup(zipEditable, options).then((request) => request(this.axios, this.basePath))
