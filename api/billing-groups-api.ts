...
export const BillingGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        billingGroupsList: async (limit?: number, offset?: number, include?: Array<string>, dateCreated?: { [key: string]: string; }, dateModified?: { [key: string]: string; }, sortByDateModified?: object, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/billing_groups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            if (sortByDateModified !== undefined) {
                localVarQueryParameter['sort_by_date_modified'] = valueToString(sortByDateModified);
            }
...
export const BillingGroupsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async billingGroupsList(limit?: number, offset?: number, include?: Array<string>, dateCreated?: { [key: string]: string; }, dateModified?: { [key: string]: string; }, sortByDateModified?: object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BillingGroupList>> {
...
export class BillingGroupsApi extends BaseAPI {
     ...
     * @memberof BillingGroupsApi
     */
    public list(limit?: number, offset?: number, include?: Array<string>, dateCreated?: { [key: string]: string; }, dateModified?: { [key: string]: string; }, sortByDateModified?: object, options?: AxiosRequestConfig) {
        return BillingGroupsApiFp(this.configuration).billingGroupsList(limit, offset, include, dateCreated, dateModified, sortByDateModified, options).then((request) => request(this.axios, this.basePath))
            .then(function (response) {
