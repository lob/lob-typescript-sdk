 ...
 * @export
 */
export const ChecksApiAxiosParamCreator = function (
...
export const ChecksApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async checkCancel(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CheckDeletion>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.checkCancel(
        chkId,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.checkCreate(
        checkEditable,
        idempotencyKey,
        options
      );
    ...
    async checkRetrieve(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Check>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.checkRetrieve(
        chkId,
        options
      );
      return createRequestFunction(
    ...
    async checksList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<CheckList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.checksList(
        limit,
        before,
        after,
        include,
