 ...
 * @export
 */
export const ReverseGeocodeLookupsApiAxiosParamCreator = function (
 ...
 * @export
 */
export const ReverseGeocodeLookupsApiFp = function (
  configuration?: Configuration
) {
  const localVarAxiosParamCreator =
    ReverseGeocodeLookupsApiAxiosParamCreator(configuration);
  return {
    /**
     * Reverse geocode a valid US location with a live API key.
     * @summary lookup
     ...
     * @throws {RequiredError}
     */
    async reverseGeocodeLookup(
      location: Location,
      size?: number,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReverseGeocode>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.reverseGeocodeLookup(
          location,
          size,
          options
        );
