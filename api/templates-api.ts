  ...
  return {
    ...
    async templateDelete(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<TemplateDeletion>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.templateDelete(
        tmplId,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.templateRetrieve(tmplId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async templateUpdate(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Template>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.templateUpdate(
        tmplId,
        templateUpdate,
        options
      );
    ...
    async templatesList(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TemplateList>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.templatesList(
        limit,
        before,
        after,
        include,
