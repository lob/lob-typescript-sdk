import {
  ...
  CountryExtended,
  LobError,
  MultipleComponents, UsVerifications, IntlVerificationWritable, IntlVerificationOrErrorCodeEnum,
} from "../models";
...
describe("Intl Verifications Models", () => {
  ...
  describe("IntlVerifications", () => {
    ...
    it('sorts LobError objects into a secondary array', () => {
      const rec = new IntlVerifications({ addresses: [new LobError({ status_code: 500 })] });
      expect(rec).toBeDefined();
