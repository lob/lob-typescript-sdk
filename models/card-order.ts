...
export class CardOrder {
  constructor(input?: any) {
    ...
    if (typeof input?.cool_card_id !== "undefined") {
      this.cool_card_id = input.cool_card_id;
    }
   ...
   * @memberof CardOrder
   */
  private "_cool_card_id"?: string;
  public get cool_card_id() {
    return (this._cool_card_id || undefined) as string;
  }
  public set cool_card_id(newValue: string) {
    if (newValue && !/^card_[a-zA-Z0-9]+$/.test(newValue)) {
      throw new Error("Invalid cool_card_id provided");
    }
    this._cool_card_id = newValue;
  }
