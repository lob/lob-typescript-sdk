...
export class SelfMailer {
    ...
    public get outside_template_id() { return (this._outside_template_id || null || undefined) as string; }
    ...
    public get inside_template_id() { return (this._inside_template_id || null || undefined) as string; }
    ...
    public get outside_template_version_id() { return (this._outside_template_version_id || null || undefined) as string; }
    ...
    public get inside_template_version_id() { return (this._inside_template_version_id || null || undefined) as string; }
