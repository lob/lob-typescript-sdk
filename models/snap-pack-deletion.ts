 ...
 * @export
 * @class SnapPackDeletion
 */
export class SnapPackDeletion {
   ...
   * @memberof SnapPackDeletion
   */
  "object"?: SnapPackDeletionObjectEnum;
 ...
 * @enum {string}
 */
export enum SnapPackDeletionObjectEnum {
  SnapPackDeleted = "snap_pack_deleted",
}
