...
exports.BankAccountsApi =
  exports.BankAccountsApiFp =
  exports.BankAccountsApiAxiosParamCreator =
    void 0;
    ...
    bankAccountCreate: function (bankAccountWritable, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("bankAccountCreate", "bankAccountWritable", bankAccountWritable);
    ...
    bankAccountDelete: function (bankId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("bankAccountDelete", "bankId", bankId);
          localVarPath = "/bank_accounts/{bank_id}".replace(
            "{".concat("bank_id", "}"),
    ...
    bankAccountRetrieve: function (bankId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          // verify required parameter 'bankId' is not null or undefined
          (0,
          common_1.assertParamExists)("bankAccountRetrieve", "bankId", bankId);
          localVarPath = "/bank_accounts/{bank_id}".replace(
            "{".concat("bank_id", "}"),
            encodeURIComponent(String(bankId))
          );
    ...
    bankAccountVerify: function (bankId, bankAccountVerify, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          // verify required parameter 'bankId' is not null or undefined
          (0,
          common_1.assertParamExists)("bankAccountVerify", "bankId", bankId);
          // verify required parameter 'bankAccountVerify' is not null or undefined
          (0,
          common_1.assertParamExists)("bankAccountVerify", "bankAccountVerify", bankAccountVerify);
          localVarPath = "/bank_accounts/{bank_id}/verify".replace(
            "{".concat("bank_id", "}"),
            encodeURIComponent(String(bankId))
          );
          localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
...
var BankAccountsApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.BankAccountsApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.bankAccountCreate(
                  bankAccountWritable,
                  options
                ),
              ];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.bankAccountDelete(bankId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.bankAccountRetrieve(bankId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.bankAccountVerify(
                  bankId,
                  bankAccountVerify,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.bankAccountsList(
                  limit,
                  before,
                  after,
                  include,
...
var BankAccountsApi = /** @class */ (function (_super) {
   ...
   * @memberof BankAccountsApi
   */
  BankAccountsApi.prototype.verify = function (
    bankId,
    bankAccountVerify,
    options
  ) {
   ...
   * @memberof BankAccountsApi
   */
  BankAccountsApi.prototype.list = function (
    limit,
    before,
    after,
    include,
