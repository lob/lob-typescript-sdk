...
exports.USAutocompletionsApi =
  exports.USAutocompletionsApiFp =
  exports.USAutocompletionsApiAxiosParamCreator =
    void 0;
...
var USAutocompletionsApiAxiosParamCreator = function (configuration) {
  ...
  return {
     ...
     */
    autocompletion: function (usAutocompletionsWritable, options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("autocompletion", "usAutocompletionsWritable", usAutocompletionsWritable);
...
exports.USAutocompletionsApiAxiosParamCreator =
  USAutocompletionsApiAxiosParamCreator;
/**
...
var USAutocompletionsApiFp = function (configuration) {
  ...
  exports.USAutocompletionsApiAxiosParamCreator)(configuration);
  return {
    /**
     * Given an address prefix consisting of a partial primary line, as well as optional input of city, state, and zip code, this functionality returns up to 10 full US address suggestions. Not all of them will turn out to be valid addresses; they\'ll need to be [verified](#operation/verification_us).
     * @summary autocomplete
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.autocompletion(
                  usAutocompletionsWritable,
                  options
                ),
              ];
...
var USAutocompletionsApi = /** @class */ (function (_super) {
  __extends(USAutocompletionsApi, _super);
   ...
   */
  USAutocompletionsApi.prototype.autocomplete = function (
    usAutocompletionsWritable,
    options
  ) {
    var _this = this;
