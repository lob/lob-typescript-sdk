...
exports.ChecksApi =
  exports.ChecksApiFp =
  exports.ChecksApiAxiosParamCreator =
    void 0;
    ...
    checkCancel: function (chkId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = "/checks/{chk_id}".replace(
            "{".concat("chk_id", "}"),
    ...
    checkCreate: function (checkEditable, idempotencyKey, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("checkCreate", "checkEditable", checkEditable);
          localVarPath = "/checks";
          localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
          if (configuration) {
            baseOptions = configuration.baseOptions;
...
var ChecksApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.ChecksApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.checkCancel(chkId, options),
              ];
            case 1:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.checkCreate(
                  checkEditable,
                  idempotencyKey,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.checkRetrieve(chkId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.checksList(
                  limit,
                  before,
                  after,
                  include,
...
var ChecksApi = /** @class */ (function (_super) {
   ...
   * @memberof ChecksApi
   */
  ChecksApi.prototype.create = function (
    checkEditable,
    idempotencyKey,
    options
  ) {
   ...
   * @memberof ChecksApi
   */
  ChecksApi.prototype.list = function (
    limit,
    before,
    after,
    include,
