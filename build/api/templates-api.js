...
exports.TemplatesApi =
  exports.TemplatesApiFp =
  exports.TemplatesApiAxiosParamCreator =
    void 0;
    ...
    createTemplate: function (templateWritable, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("createTemplate", "templateWritable", templateWritable);
    ...
    templateDelete: function (tmplId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = "/templates/{tmpl_id}".replace(
            "{".concat("tmpl_id", "}"),
    ...
    templateUpdate: function (tmplId, templateUpdate, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("templateUpdate", "templateUpdate", templateUpdate);
          localVarPath = "/templates/{tmpl_id}".replace(
            "{".concat("tmpl_id", "}"),
            encodeURIComponent(String(tmplId))
          );
...
var TemplatesApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.TemplatesApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.createTemplate(
                  templateWritable,
                  options
                ),
              ];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.templateDelete(tmplId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.templateRetrieve(tmplId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.templateUpdate(
                  tmplId,
                  templateUpdate,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.templatesList(
                  limit,
                  before,
                  after,
                  include,
...
var TemplatesApi = /** @class */ (function (_super) {
   ...
   * @memberof TemplatesApi
   */
  TemplatesApi.prototype.list = function (
    limit,
    before,
    after,
    include,
