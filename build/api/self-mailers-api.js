...
exports.SelfMailersApi =
  exports.SelfMailersApiFp =
  exports.SelfMailersApiAxiosParamCreator =
    void 0;
    ...
    selfMailerCreate: function (selfMailerEditable, idempotencyKey, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("selfMailerCreate", "selfMailerEditable", selfMailerEditable);
    ...
    selfMailerDelete: function (sfmId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = "/self_mailers/{sfm_id}".replace(
            "{".concat("sfm_id", "}"),
...
var SelfMailersApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.SelfMailersApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.selfMailerCreate(
                  selfMailerEditable,
                  idempotencyKey,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.selfMailerDelete(sfmId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.selfMailerRetrieve(sfmId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.selfMailersList(
                  limit,
                  before,
                  after,
                  include,
...
var SelfMailersApi = /** @class */ (function (_super) {
  __extends(SelfMailersApi, _super);
   ...
   */
  SelfMailersApi.prototype.create = function (
    selfMailerEditable,
    idempotencyKey,
    options
  ) {
   ...
   * @memberof SelfMailersApi
   */
  SelfMailersApi.prototype.list = function (
    limit,
    before,
    after,
    include,
