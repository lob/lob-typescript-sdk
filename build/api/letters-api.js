...
exports.LettersApi =
  exports.LettersApiFp =
  exports.LettersApiAxiosParamCreator =
    void 0;
    ...
    letterCancel: function (ltrId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = "/letters/{ltr_id}".replace(
            "{".concat("ltr_id", "}"),
    ...
    letterCreate: function (letterEditable, idempotencyKey, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("letterCreate", "letterEditable", letterEditable);
...
var LettersApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.LettersApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.letterCancel(ltrId, options),
              ];
            case 1:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.letterCreate(
                  letterEditable,
                  idempotencyKey,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.letterRetrieve(ltrId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.lettersList(
                  limit,
                  before,
                  after,
                  include,
...
var LettersApi = /** @class */ (function (_super) {
   ...
   * @memberof LettersApi
   */
  LettersApi.prototype.create = function (
    letterEditable,
    idempotencyKey,
    options
  ) {
   ...
   * @memberof LettersApi
   */
  LettersApi.prototype.list = function (
    limit,
    before,
    after,
    include,
