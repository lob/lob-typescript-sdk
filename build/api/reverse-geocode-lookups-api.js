...
exports.ReverseGeocodeLookupsApi =
  exports.ReverseGeocodeLookupsApiFp =
  exports.ReverseGeocodeLookupsApiAxiosParamCreator =
    void 0;
    ...
    reverseGeocodeLookup: function (location, size, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("reverseGeocodeLookup", "location", location);
...
exports.ReverseGeocodeLookupsApiAxiosParamCreator =
  ReverseGeocodeLookupsApiAxiosParamCreator;
/**
...
var ReverseGeocodeLookupsApiFp = function (configuration) {
  ...
  exports.ReverseGeocodeLookupsApiAxiosParamCreator)(configuration);
  return {
    /**
     * Reverse geocode a valid US location with a live API key.
     * @summary lookup
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.reverseGeocodeLookup(
                  location,
                  size,
                  options
                ),
...
var ReverseGeocodeLookupsApi = /** @class */ (function (_super) {
  __extends(ReverseGeocodeLookupsApi, _super);
   ...
   */
  ReverseGeocodeLookupsApi.prototype.lookup = function (
    location,
    size,
    options
  ) {
