...
exports.CardsApi =
  exports.CardsApiFp =
  exports.CardsApiAxiosParamCreator =
    void 0;
...
var CardsApiAxiosParamCreator = function (configuration) {
  ...
  return {
    ...
    cardCreate: function (cardEditable, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("cardCreate", "cardEditable", cardEditable);
          localVarPath = "/cards";
    ...
    cardDelete: function (cardId, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          localVarPath = "/cards/{card_id}".replace(
            "{".concat("card_id", "}"),
    ...
    cardUpdate: function (cardId, cardUpdatable, options) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          (0,
          common_1.assertParamExists)("cardUpdate", "cardUpdatable", cardUpdatable);
          localVarPath = "/cards/{card_id}".replace(
            "{".concat("card_id", "}"),
            encodeURIComponent(String(cardId))
          );
     ...
     * @throws {RequiredError}
     */
    cardsList: function (limit, before, after, sortBy, options) {
      if (options === void 0) {
        options = {};
      }
      return __awaiter(_this, void 0, void 0, function () {
...
var CardsApiFp = function (configuration) {
  var localVarAxiosParamCreator = (0, exports.CardsApiAxiosParamCreator)(
    configuration
  );
  return {
    /**
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.cardCreate(cardEditable, options),
              ];
            case 1:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.cardDelete(cardId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.cardRetrieve(cardId, options),
              ];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.cardUpdate(
                  cardId,
                  cardUpdatable,
                  options
                ),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                localVarAxiosParamCreator.cardsList(
                  limit,
                  before,
                  after,
                  sortBy,
...
var CardsApi = /** @class */ (function (_super) {
   ...
   * @memberof CardsApi
   */
  CardsApi.prototype.list = function (limit, before, after, sortBy, options) {
    var _this = this;
    return (0, exports.CardsApiFp)(this.configuration)
